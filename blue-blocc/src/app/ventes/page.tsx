...
import { Plus, AlertTriangle, TrendingUp, TrendingDown, ChevronLeft, ChevronRight, BarChart2 } from 'lucide-react'
...
export default function VentesPage() {
  ...
  const handleSubmit = async (ev: React.FormEvent) => {
    ...
    if (!stockDispo || stockDispo.prixAchatUnitaire <= 0) { setError("Aucun stock disponible. Recharge d'abord l'entrepôt."); return }
    if (stockDispo.quantite < qty) { setError(`Stock insuffisant : ${formatKg(stockDispo.quantite)} disponibles`); return }

    const item = items.find(i => i.id === selectedItemId)
    const prixAchat = stockDispo.prixAchatUnitaire
          ...
          <div className="card p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {stockDispo !== null && selectedItemId && (
